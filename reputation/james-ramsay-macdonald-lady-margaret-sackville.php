    ...
    <div id="section-one">
        ...
        <div class="container">
            ...
            <div class="document-summary text-center">
                ...
                <a href="https://discovery.nationalarchives.gov.uk/details/r/C11287091" class="btn-primary text-center" title="" id="james-ramsay-macdonald-lady-margaret-sackville-catalogue-description">View this document in our catalogue</a>
            </div>
            ...
            <div class="row mb-4">
                <div class="col-md-6 p-3">
                    ...
                    <!-- Modal one -->
                    <div class="modal fade" id="reputation-1-1" tabindex="-1" role="dialog" aria-labelledby="modal-title-one" aria-hidden="true" data-backdrop="false">
                ...
                <div class="col-md-6 p-3">
                    ...
                    <!-- Modal two -->
                    <div class="modal fade" id="reputation-1-2" tabindex="-1" role="dialog" aria-labelledby="modal-title-two" aria-hidden="true" data-backdrop="false">
                        <div class="modal-dialog modal-dialog-centered modal-custom" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
