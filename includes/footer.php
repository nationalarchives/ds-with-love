    ...
    <footer class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-2 p-4">
                <a class="logo-placement" title="External website - opens in a new window" href="https://gov.uk/" target="_blank" rel="noopener noreferrer">
                    <img alt="GOV.UK logo" src="https://www.nationalarchives.gov.uk/images/global/gov-uk.png" class="mt-0 mr-0">
                </a>
            </div>
        </div>
    </footer>
...
<script src="../js/with-love-tracking.js"></script>
</body>
</html>
